...
export class Backend implements backendInterface {
    ...
    async getAllSessions(): Promise<Array<ChatSession>> {
        if (this.processError) {
            try {
    ...
    async getAllSessionsByTitle(): Promise<Array<ChatSession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSessionsByTitle();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMessages(arg0: SessionId): Promise<Array<Message>> {
        if (this.processError) {
            try {
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        role: from_candid_variant_n4(_uploadFile, _downloadFile, value.role),
